...
var defaultInputValidators = {
  email: function email(string) {
    return (/^[a-zA-Z0-9.+_-]+@wangsu.com$/.test(string) ? Promise.resolve() : Promise.reject('username@wangsu.com')
    );
  },
  //   email: function email(string) {
  //   return (/^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(string) ? Promise.resolve() : Promise.reject('username@wangsu.com')
  //   );
  // },
//   text: function text(string) {
//     return (/^[a-zA-Z0-9.+_-~!@#$%^&*,\.<>\[\]{}]+$/.test(string) ? Promise.resolve() : Promise.reject('该字段不能为空！')
//   );
// },
  url: function url(string) {
    // taken from https://stackoverflow.com/a/3809435/1331425
    return (/^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)$/.test(string) ? Promise.resolve() : Promise.reject('URL格式错误')
    );
  }
};
